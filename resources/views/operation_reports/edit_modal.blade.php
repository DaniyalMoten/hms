                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            ...
                            <span class="required"></span>
                            {{ Form::text('date', null, ['class' => getLoggedInUser()->thememode ? 'bg-light form-control' : 'bg-white form-control', 'required', 'id' => 'editOperationDate', 'autocomplete' => 'off']) }}
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group mb-5">
                            {{ Form::label('description', __('messages.operation_report.description') . ':', ['class' => 'form-label']) }}
                            {{ Form::textarea('description', null, ['class' => 'form-control', 'id' => 'editOperationDescription', 'rows' => 5]) }}
                        </div>
                    </div>
                </div>
            </div>

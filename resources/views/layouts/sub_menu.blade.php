...
@role('Admin|Accountant')
    @module('Accounts', $modules)
        <li
            class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('accounts*', 'employee-payrolls*', 'invoices*', 'payments*', 'payment-reports*', 'advanced-payments*', 'bills*') ? 'd-none' : '' }}">
...
@role('Admin|Receptionist')
    ...
    @role('Admin|Receptionist')
        @module('Doctors', $modules)
            <li
                class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('doctors*', 'doctor-departments*', 'schedules*') ? 'd-none' : '' }}">
    ...
    @module('Medicines', $modules)
        ...
        @role('Admin|Receptionist')
            @module('Pathology Categories', $modules)
                <li
                    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('pathology-categories*', 'pathology-tests*') ? 'd-none' : '' }}">
        ...
        @role('Admin|Doctor|Patient')
            @module('Live Consultations', $modules)
                <li
                    class="nav-item position-relative mx-xl-3 mb-3 mb-xl-0 {{ !Request::is('live-consultation*', 'live-meeting*') ? 'd-none' : '' }}">

...
@elseif ($theme === 'bootstrap-4')
    ...
    {{--                        {{ $rows->links('livewire-tables::specific.bootstrap-4.pagination') }} --}}
    {{--                    </div> --}}
    {{--                    <div class="col-12 col-md-6 text-center text-md-end text-muted d-flex align-items-center justify-content-md-start justify-content-center mb-md-0 mb-4"> --}}
        ...
        @if ($component->paginationVisibilityIsEnabled())
            @if ($component->paginationIsEnabled() && $component->perPageVisibilityIsEnabled())
                <div class="mb-xxl-0 d-flex align-items-center justify-content-sm-start justify-content-center">
                    <span class="me-3 text-gray-600 fs-4 fs-xl-6">{{ __('messages.common.show') }}</span>

...
function loadSchedules() {
    ...
    listenSubmit(".scheduleForm", function (e) {
        ...
        if (perPatientTime == "00:00:00") {
            $("#scheduleErrorsBox")
                .html(Lang.get("messages.schedule.schedule_time_select"))
                .show();
        ...
        for (j; j <= 6; j++) {
            if ($("#availableFrom-" + j).val() != "00:00:00") {
                ...
                if (
                    ...
                    $("#scheduleErrorsBox")
                        .show()
                        .html(Lang.get("messages.schedule.schedule_time"))
                        .show();
        ...
        if (availableFrom) {
            $("#scheduleErrorsBox")
                ...
                .html(
                    Lang.get(
                        "messages.schedule.available_time_greater_than_zero"
                    )
                );
            $("#scheduleErrorsBox").delay(5000).fadeOut();
            return false;
            ...
            if ($("#availableTo-" + i).val() != "00:00:00") {
                ...
                if (
                    ...
                    $("#scheduleErrorsBox")
                        ...
                        .html(
                            Lang.get(
                                "messages.schedule.available_time_less_than_hospital_schedule_time"
                            )
                        )
                        .show();
                    $("#scheduleErrorsBox").delay(5000).fadeOut();
        ...
        if (availableTo) {
            $("#scheduleErrorsBox")
                ...
                .html(
                    Lang.get(
                        "messages.schedule.available_to_time_greater_than_zero"
                    )
                );
            $("#scheduleErrorsBox").delay(5000).fadeOut();
            return false;
